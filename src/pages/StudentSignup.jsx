...
const StudentSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const success = await register(formData.username, formData.email, formData.password, 'STUDENT', formData.rollNumber);
    setIsLoading(false);
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-large">
          <CardHeader className="text-center pb-6">
            <CardTitle className="text-3xl font-bold">Student Signup</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="rollNumber" placeholder="Enter your roll number" value={formData.rollNumber} onChange={(e) => setFormData({ ...formData, rollNumber: e.target.value })} required />
                </div>
              </div>
